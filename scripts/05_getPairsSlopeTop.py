...
in_file = sys.argv[2]       # output04.csv.gz
out_file = sys.argv[3]      # GTEx_Analysis_v7_eQTL_allTissues_slope_top.csv.gz = output05.csv.gz

# For each tissue merge the eQTL with the list of eQTL we are interested in
pairs_tissues = read_csv(in_file)
...
for tissue in tissues_names:
    ...
    tissue_data = read_csv(eqtl_file, sep='\t')
